...
//        return "category/edit";
    ...
    public RedirectView delete(@RequestParam int id, RedirectAttributes redir) {
        RedirectView redirectView = new RedirectView("/category");
        try {
            categoryService.deleteById(id);
        } catch (DataIntegrityViolationException e) {
            FlashMessage flashMessage = new FlashMessage("This Category can not be deleted as there are one or more items present under this category.",
